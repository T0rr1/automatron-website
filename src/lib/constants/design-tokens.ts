// Design tokens for Automatron.ai
...
export const getColor = (color: string, shade?: number) => {
  ...
  // Usage: getColor('brand', 500) or getColor('brand-500')
  if (shade) {
...
export const getBreakpoint = (bp: keyof typeof designTokens.breakpoints) => 
  designTokens.breakpoints[bp]